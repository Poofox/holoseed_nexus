...
**Call `planty_wakeup` before doing anything else.**

This tool:
- Verifies nexus_state.json integrity
- Checks for lock conflicts
- Returns the safety protocol briefing
- Tells you if you're clear to proceed

If it says BLOCKED or ERROR, stop and tell the human.

## What It Does

| Tool | Description |
|------|-------------|
| `planty_wakeup` | **CALL FIRST** - Wakeup protocol check |
